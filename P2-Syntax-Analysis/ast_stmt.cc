...
SwitchStmt::SwitchStmt(Expr *e, List<CaseStmt *> *s, DefaultStmt *ds)
{
    Assert(e != NULL && s != NULL && ds != NULL);
    (expr = e)->SetParent(this);
    (cases = s)->SetParentAll(this);
    (default_stmt = ds)->SetParent(this);
}
...
void SwitchStmt::PrintChildren(int indentLevel)
{
    ...
    default_stmt->Print(indentLevel + 1);
}

CaseStmt::CaseStmt(Expr *e, List<Stmt *> *s)
{
